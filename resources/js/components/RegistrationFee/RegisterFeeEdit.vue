  ...
  <div class="contentBoxing">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Registration Fee</h1>
          </div><!-- /.col -->
            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Edit Registration Fee</h3>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-10">
                      <div class="input-group mb-3">
                        ...
                        <select class="form-control" @change="YearEvent" v-model="form.year_id">
...
<!--                  class Show: {{class_show}} Year_id:{{year_show}}-->
            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                <div class="card-header">
                  ...
                  <h4 class="text-center">Addable Data</h4>
                  <hr>
                  <h5 class="text-center">{{ year_show }}</h5>
                </div>
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary mt-2" disabled v-if="this.form.class_id.length === 0 || this.form.amount.length === 0 || this.form.year_id.length === 0">Update Listed</button>
...
export default {
  ...
  methods:{
    ...
    pageTitle(){
      document.title = 'Edit Register Fe'
    },
    authenticate(){
    ...
    getByIdFee(){
      ...
      axios.get('/regifee/'+this.$route.params.id).then(res => {

        // Year
        this.form.year_id = res.data[0].year.id
        this.year_show = res.data[0].year.name

        let classArray = res.data

        classArray.forEach(cls => {
          this.form.class_id.push(cls.student_class.id)
          this.class_show.push(cls.student_class.name)
          this.form.amount.push(cls.amount);
        })
    ...
    updateData(){
      ...
      axios.put('/regifee/'+this.$route.params.id, this.form)
          .then(response => {
            this.$router.push({name: 'regifee'})
    ...
    validateData(){
      if (this.add_class_id.length === 0 || this.add_amount.length === 0 || this.form.year_id.length === 0){
