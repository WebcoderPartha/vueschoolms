              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary mt-2" disabled v-if="this.form.class_id.length === 0 || this.form.amount.length === 0 || this.form.year_id.length === 0">Insert Listed</button>
