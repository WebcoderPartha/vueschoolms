          ...
          <div class="col-md-6 mx-auto">
            <div class="card">
              ...
              <div class="card-body">
                    ...
                    <div class="col-md-10">
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text">Examtype name</span>
                        </div>
                ...
                <router-link :to="{name:'examtype'}" class="btn btn-info">Back</router-link>
              </div>
...
export default {
  ...
  methods:{
    ...
    getById(){
      axios.get('/examtype/'+this.$route.params.id).then(res=> this.form = res.data)
    },
    updateData(){
      if (!this.validateData()){
        axios.put('/examtype/'+this.$route.params.id, this.form)
            .then(response => {
