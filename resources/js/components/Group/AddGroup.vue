                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <div class="input-group mb-3">
                        ...
                        <input type="text"  v-model="add_group" class="form-control" placeholder="name">
                      </div>
  ...
  methods:{
    ...
    addItem(){
      ...
      if (!this.validateData()){
        this.form.name.push(this.add_group)
        if (this.form.name.indexOf(this.add_group) !== this.form.name.lastIndexOf(this.add_group)){
