          ...
          <div class="col-md-6 mx-auto">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <router-link :to="{name:'group'}" class="btn btn-info">Back</router-link>
              </div>
...
export default {
  ...
  methods:{
    ...
    getById(){
      axios.get('/group/'+this.$route.params.id).then(res=> this.form = res.data)
    },
    updateData(){
      if (!this.validateData()){
        axios.put('/group/'+this.$route.params.id, this.form)
            .then(response => {
