  ...
  <div class="contentBoxing">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Monthly Fee</h1>
          </div><!-- /.col -->
            ...
            <div class="col-md-8 mx-auto">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Edit Monthly Fee</h3>
                </div>
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      <div class="input-group mb-3">
                        ...
                        <select class="form-control" @change="monthEvent" v-model="form.month_id">
            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                <div class="card-header">
                  ...
                  <h5 class="text-center">Updatable Data <br> Monthly Fee</h5>
                ...
                <div class="card-body">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary mt-2" disabled v-if="this.form.month_id.length === 0 || this.form.class_id.length === 0 || this.form.amount.length === 0 || this.form.year_id.length === 0">Update Listed</button>
...
export default {
  ...
  methods:{
    ...
    pageTitle(){
      document.title = 'Edit Monthly Fee'
    },
    authenticate(){
    ...
    getYearMonthByData(){
      axios.get('/monthlyfee/'+this.$route.params.year+'/'+this.$route.params.month).then(res => {
        this.form.month_id = res.data[0].month_id
        this.form.year_id = res.data[0].year_id;
        res.data.forEach(value => {
          this.form.class_id.push(value.class_id)
          this.form.amount.push(value.amount);
          this.class_show.push(value.student_class.name);
    ...
    updateData(){
      ...
      axios.put('/monthlyfee/'+this.$route.params.year+'/'+this.$route.params.month, this.form)
          .then(response => {
