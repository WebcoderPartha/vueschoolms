            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-10">
                      <div class="input-group mb-3">
                        ...
                        <input type="text"  v-model="add_shift" class="form-control" placeholder="name">
                      </div>
                  ...
                  <router-link :to="{name:'shift'}" class="btn btn-danger">Back</router-link>
  ...
  methods:{
    ...
    addItem(){
      ...
      if (!this.validateData()){
        this.form.name.push(this.add_shift)
        if (this.form.name.indexOf(this.add_shift) !== this.form.name.lastIndexOf(this.add_shift)){
