            ...
            <div class="col-md-6 mx-auto">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button type="submit" :to="{name:'shift'}" class="btn btn-info">Update Leave</button>
...
export default {
  ...
  methods:{
    ...
    getIdByData(){
      axios.get('/leave/'+this.$route.params.id).then(res => this.form = res.data)
    },
    updateData(){
      if (!this.validateData()){
        axios.put('/leave/'+this.$route.params.id, this.form)
            .then(response => {
