        ...
        <div class="row">
          ...
          <div class="col-md-6 mx-auto">
            <div class="card">
              ...
              <div class="card-body">
                <form @submit.prevent="updateData" ref="clearform">
                  <div class="row">
                    <div class="col-md-10">
                ...
                <router-link :to="{name:'designation'}" class="btn btn-info">Back</router-link>
              </div>
...
export default {
  ...
  methods:{
    pageTitle(){
      document.title = 'Edit Designation'
    },
    authenticate(){
    ...
    getById(){
      axios.get('/designation/'+this.$route.params.id).then(res=> this.form = res.data)
    },
    updateData(){
      if (!this.validateData()){
        axios.put('/designation/'+this.$route.params.id, this.form)
            .then(response => {
